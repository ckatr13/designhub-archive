...
(c) Kai Blankenhorn
modified by Lloyd Alvarez (lloyd@shake.com)
www.bitfolge.de
kaib@bitfolge.de
 ...
 **/
$externalIcons = Array (
	"archive"	=> "../do_not_delete/zip.gif",
	"binary"	=> "../do_not_delete/scripts.gif",
	"dirup"   => "../do_not_delete/go_up.gif",
	"folder"	=> "../do_not_delete/folder.gif",
	"HTML"		=> "../do_not_delete/web.gif",
	"image"		=> "../do_not_delete/pic.gif",
	"video"		=> "../do_not_delete/video.gif",
	"sound"		=> "../do_not_delete/sound.gif",
	"music"		=> "../do_not_delete/music.gif",
	"word"		=> "../do_not_delete/word.gif",
	"excel"		=> "../do_not_delete/excel.gif",
	"ppt"		=> "../do_not_delete/ppt.gif",
	"pdf"		=> "../do_not_delete/pdf.gif",
	"photoshop"	=> "../do_not_delete/photoshop.gif",
	"text"		=> "../do_not_delete/text.gif",
	"unknown"	=> "../do_not_delete/unknown.gif",
	"download"	=> "../do_not_delete/download.gif",   // 7x16 pixels
	"asc"		=> "../do_not_delete/asc.gif",       // 5x3 pixels
	"desc"		=> "../do_not_delete/desc.gif"      // 5x3 pixels
);
...
$languageStrings = Array(
	"en" => Array(
		...
		"video" => "", // a video file
		"dirup" => "Up to the previous directory", // tooltip of the .. folder icon
		"download" => "Download file to disk", // tooltip of the download icon to the left
		"asc" => "Sort in ascending order", // sort in ascending order

		"desc" => "Sort in descending order", // sort in descending order
		"[ back ]" => "Back", // special name displayed for the .. folder
...
function getFileType($fileInfo) {
	...
	static $fileTypes = Array(
		"HTML"		=> Array("html","htm"),
		"image"		=> Array("gif","jpg","jpeg","png","bmp","art"),
		"photoshop"	=> Array("tif","tiff","psd","tga","pic"),
		...
		"binary"	=> Array("asf","bin","class","exe","ogm", "ps","rm","swf"),
		"video"	=> Array("mov","qt","mpg","mpeg","avi","wmv","wmf","divx"),
		"sound"	=> Array("au","aif","aiff","wav"),
		"music"	=> Array("mp3","m4a","ogg"),
		"pdf"		=> Array("pdf"),
		"word"	=> Array("doc"),
		"ppt"		=> Array("ppt"),
		"excel"	=> Array("xls"),
		//"document"=> Array("doc","pdf","ppt","ps","rtf","xls"),
		"archive"	=> Array("ace","arc","bz2","cab","gz","lha","jar","rar","sit","sitx","tar","tbz2","tgz","z","zip","zoo")
	);
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title><?php echo translate("Client Area for")." ".htmlentities(dirname($_SERVER["PHP_SELF"])."/");?></title>
		<?php 
		if ($externalStylesheet!="") {
			?>
...
<table cellpadding="0" cellspacing="0" class="snif">
	<tr>
		<td class="snDir" colspan="<?php echo count($displayColumns)?>">
			<?php echo $descriptions["header"];?><br/>
			<span class="snifSmaller"><?php echo $descriptions["subhead"];?></span>
		</td>
	</tr>
	<?php 
	if ($pagingInEffect) {
...
<br/>
<a href="http://www.giantoctopus.com">Design, concepts and logos copyright 2005 Giant Octopus. Submitted in commercial confidence.</a>
</div>
</body>
</html>